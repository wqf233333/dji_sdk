...
namespace motion_controls
{
    ...
    )
    {
        ...
        send_data.roll_or_x = los.x - position_refs::local_position_ref.x;
        send_data.pitch_or_y = los.y - position_refs::local_position_ref.y;
        send_data.thr_z = los.height; //m/s
        send_data.yaw = gimbal::gimbal_yaw_control_sp;

//        printf("%f %f \n",
//               los.x - position_refs::local_position_ref.x,
//               los.x - position_refs::local_position_ref.x
//        );
